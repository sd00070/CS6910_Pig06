...
## Taking "simplest possible code" as literally as I can
> I'm taking "simplest possible code" as literally as I can, to the extent some of the code is not optimized. I personally would like to refactor some of the `if` statements (pulling the check for either player winning into a helper method, for example), but as I am afraid that will penalize me for this exercise, I am going to leave the code as it it.
